...
//    private ScrollView scrollView;
    ...
    int newCheck = 50;
    public static  int OFF_SET_DEFAULT = 1;
    private int offset = OFF_SET_DEFAULT; // 偏移量（需要在最前面和最后面补全）
    //由于wheelview单位时间内只显示3个，
    // 这里是通过在初始数据的首尾分别加上“” 空字符。
    // 让wheelview上下滑动能保证每个item都能滑到中间取值
    public static final String TAG = WheelView.class.getSimpleName();//获取当前类的类名
//内置滑动监听
    public static class OnWheelViewListener {
    //seleterdIndex 当前所选项的索引
    //item 所选项内容
    ...
    //    String[] items;
    List<String> items;//wheelview滑动内容
...
//        this.setOrientation(VERTICAL);
        this.setVerticalScrollBarEnabled(false);//隐藏垂直方向的滚动条
        ...
        scrollerTask = new Runnable() {
            ...
            public void run() {
                ...
                int newY = getScrollY();//获取当前view上边缘到内容上边缘的距离
